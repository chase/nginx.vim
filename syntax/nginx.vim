...
" Push Stream Module <http://github.com/wandenberg/nginx-push-stream-module>
" A pure stream HTTP push techonology for your Nginx setup. Comet made easy
" and really scalable.
syn keyword ngxDirectiveThirdParty push_stream_channel_id
...
syn keyword ngxDirectiveThirdParty push_stream_websocket
syn keyword ngxDirectiveThirdParty push_stream_shared_memory_size
syn keyword ngxDirectiveThirdParty push_stream_shared_memory_cleanup_objects_ttl
...
syn keyword ngxDirectiveThirdParty push_stream_max_number_of_broadcast_channels
syn keyword ngxDirectiveThirdParty push_stream_broadcast_channel_prefix
...
syn keyword ngxDirectiveThirdParty push_stream_content_type
syn keyword ngxDirectiveThirdParty push_stream_broadcast_channel_max_qtd
syn keyword ngxDirectiveThirdParty push_stream_keepalive
syn keyword ngxDirectiveThirdParty push_stream_eventsource_support
